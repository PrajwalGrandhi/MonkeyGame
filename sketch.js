...
function setup()
{
 ...
 ground=createSprite(300,575,600,50);
...
{ 
  //space
  if(keyDown("space") && monk.y>300 && gamestate=="play")
     {
     monk.velocityY=-10;
     }
  //gravity
  ...
  if(frameCount%rand==0 && gamestate=="play")
   ...
   if(bananaGroup.isTouching(edges[0])&& gamestate=="play")
      {
        score=score-50;
...
function banana()
{
  ...
  ban=createSprite(600,rand,20,20);
